        ...
        return new SensorAccuracyChangeListener() {
            ...
            public void onCompassAccuracyChanged( int accuracy ) {
                ...
                if ( accuracy < SensorManager.SENSOR_STATUS_ACCURACY_MEDIUM &&
                        SampleCamActivity.this != null &&
                        !SampleCamActivity.this.isFinishing() &&
                        System.currentTimeMillis() - SampleCamActivity.this.lastCalibrationToastShownTimeMillis > 5 * 1000) {
